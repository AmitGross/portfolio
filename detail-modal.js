...
(function () {
  ...
  var CARD_DATA = {
    ...
    'ds-03': {
      ...
      context: '\u00b7 the Technion Civil Engineering ECSL Lab, connected to spatio-temporal data, mapping, and geolocation analysis.',
    ...
    'ds-04': {
      ...
      title: 'Simplified Analytical Tree Pipeline',
      tags: ['SWC', 'NetworkX', 'Synapses', 'Tree Graph', 'SFC', 'SI'],
      desc: 'This pipeline transforms raw neuron morphology and synaptic annotations into a simplified NetworkX tree representation for downstream connectome analysis. The goal is to preserve the relevant branching structure and synaptic organization while reducing the full morphology into an analytical graph that can support axon/dendrite splitting, graph compression, node filtering, and Segregation Index calculation.',
      context: 'The starting point is an SWC morphology file describing a neuron as a directed tree, together with a synapse table containing pre- and post-synaptic sites. Synapses are attached to the neuronal skeleton, and Synapse Flow Centrality is used to split the neuron into axonal and dendritic compartments. From this split, separate NetworkX tree objects are generated while preserving parent-child structure, node coordinates, and synaptic information.',
      did: 'Parsed SWC morphology files into directed tree structures \u00b7 Attached pre/post-synaptic sites to graph nodes \u00b7 Applied Synapse Flow Centrality for axon/dendrite compartmentalization \u00b7 Compressed the morphology by pruning non-informative nodes and collapsing linear chains \u00b7 Filtered ambiguous synaptic configurations \u00b7 Aggregated synaptic information backward through the tree \u00b7 Calculated Segregation Index values based on pre/post synapse distributions across child branches.',
      methods: 'Python \u00b7 NetworkX \u00b7 SWC morphology \u00b7 Synapse Flow Centrality \u00b7 Graph compression \u00b7 Tree traversal \u00b7 Synapse aggregation \u00b7 Segregation Index',
      output: 'Simplified analytical tree representations \u00b7 Axon/dendrite compartment trees \u00b7 Compressed graph structures \u00b7 Node-level Segregation Index values \u00b7 Pipeline diagram showing the transition from morphology and synapses to an analysis-ready tree.',
      figures: {
        featured: {
          src: 'data/connectome/pipeline_docv.png',
          caption: 'Pipeline diagram showing how neuron morphology and synaptic sites are transformed into a simplified analytical tree for graph-based connectome analysis.',
    ...
    'ops-02': {
      ...
      desc: 'Led KPI reporting and data-workflow improvements for an international (EMEA) healthcare operations program at IQVIA, standardizing reporting logic, calculations, and performance tracking.',
